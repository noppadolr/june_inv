...
@endphp
    <div data-simplebar class="h-100">
        ...
        <div class="user-profile text-center mt-3">
            <div class="">
                <img src="{{ url($adminData->avatar) }}" alt="" class="avatar-md rounded-circle">
            </div>
            <div class="mt-3">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('supplier.all') }}">Supllier All</a></li>
                        <li><a href="{{ route('supplier.add') }}">Supllier Add</a></li>
